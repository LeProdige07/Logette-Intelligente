    ...
    <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="sidebar-left" data-simplebar style="height: 100%;">
            ...
            <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li class="has-sub {{ request()->is('roles') ? 'active expand' : '' }} {{ request()->is('roles/create') ? 'active expand' : '' }}">
                    ...
                    <ul class="collapse {{ request()->is('roles') ? 'show' : '' }} {{ request()->is('roles/create') ? 'show' : '' }}" id="role" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            ...
                            <li class="{{ request()->is('roles/create') ? 'active' : '' }}">
                                <a class="sidenav-item-link" href="{{route('roles.create')}}">
                                    <span class="nav-text">Créer un role</span>
                ...
                <li class="has-sub {{ request()->is('users') ? 'active expand' : '' }} {{ request()->is('users/create') ? 'active expand' : '' }}">
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#user"
                        aria-expanded="false" aria-controls="user">
                        <i class="mdi mdi-account-group"></i>
                        <span class="nav-text">Abonnés</span> <b class="caret"></b>
                    </a>
                    <ul class="collapse {{ request()->is('users') ? 'show' : '' }} {{ request()->is('users/create') ? 'show' : '' }}" id="user" data-parent="#sidebar-menu">
                        <div class="sub-menu">
                            ...
                            <li class="{{ request()->is('users/create') ? 'active' : '' }}">
                                <a class="sidenav-item-link" href="{{route('users.create')}}">
                                    <span class="nav-text">Créer un abonné</span>
